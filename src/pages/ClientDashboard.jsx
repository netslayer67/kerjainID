        ...
        <AnimatedPage>
            ...
            <MotionConfig reducedMotion="user">
                <div className="relative min-h-screen w-full px-4 py-6 md:px-8 text-foreground overflow-hidden">
                    ...
                    >
                        <div className="flex flex-col gap-3 p-5 text-center md:text-left md:flex-row md:items-center md:justify-between md:p-6">
                            {/* Greeting */}
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Target hari ini: cepat, rapi, beres.
                                </p>
                            </div>

                            {/* Button (full width on mobile, auto on desktop) */}
                            <Link to="/post-job" className="w-full md:w-auto mt-3 md:mt-0">
                                <Button
                                    size="lg"
                                    className="w-full md:w-auto font-semibold rounded-xl"
                                >
                    ...
                    <section className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
                        {[
                            ...
                            >
                                <Card className="rounded-2xl border border-border/40 bg-card/60 backdrop-blur hover:bg-card/70 transition">
                    ...
                    <section className="mt-8">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
                            {quickActions.map((action, i) => (
                                ...
                                >
                                    <Link to={action.path}>
                                        <Card className="rounded-2xl border border-border/40 bg-card/60 backdrop-blur hover:shadow-sm transition">
                                            <CardContent className="flex h-24 flex-col items-center justify-center gap-2 p-3">
                                                <div className="rounded-xl border border-border/50 bg-background/50 p-2 group-hover:scale-105 transition">
                        ...
                        {activeJobs.length > 0 ? (
                            ...
                            <motion.div {...fadeUp}>
                                <div className="rounded-3xl border border-dashed border-border/60 bg-card/40 backdrop-blur p-10 text-center">
                                    <p className="text-muted-foreground">Belum ada job aktif.</p>
                                    <div className="mt-4">
                                        <Link to="/post-job">
